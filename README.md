# Quintolin: shared configuration for CI

This repository contains common configuration files
used in GitHub Actions and GitLab CI.
...
- [GitHub](https://github.com/quintolin/config-ci) (main mirror)
- [GitLab](https://gitlab.com/quintolin/config-ci)
- [Bitbucket](https://bitbucket.org/quintolin/config-ci)
- [Codeberg](https://codeberg.org/quintolin/config-ci)
- [Disroot](https://git.disroot.org/quintolin/config-ci)
